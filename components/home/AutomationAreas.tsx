        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {automationAreas.map((area) => (
            <Link
              ...
              className="group flex flex-col rounded-lg border border-zinc-800 bg-zinc-900 p-6 transition-colors hover:border-brand-gold/50"
            >
              <h3 className="text-lg font-semibold text-zinc-50 group-hover:text-brand-gold">
                {area.title}
              </h3>
