...
//
// V sekci stojí AŽ ZA formulářem: úkolem sekce je formulář, tohle je
// úniková cesta pro lidi, kteří formulář nevyplní. Kdyby stály nad ním,
// odvádějí od hlavní akce.
const channels = [
  {
    label: "E-mail",
...
export default function ContactChannels() {
  return (
    <div>
      <p className="text-sm text-zinc-400">Nebo mi napište přímo:</p>
          ...
          <AnimatedSection key={channel.label} delay={i * 0.08}>
            ...
            >
              <div className="flex items-center gap-4">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-zinc-900 text-brand-turquoise">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-50">{channel.value}</p>
                </div>
              </div>
            </GlowCard>
          </AnimatedSection>
